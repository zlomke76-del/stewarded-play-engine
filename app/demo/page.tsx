...
import { useDemoRuntime, displayName } from "./hooks/useDemoRuntime";
...
export default function DemoPage() {
  ...
  return (
    <AmbientBackground>
      ...
      <audio ref={demo.introAudioRef} preload="auto" src="/audio/music/chronicles_intro.mp3" style={{ display: "none" }} />
      <audio ref={demo.bgmAudioRef} preload="auto" style={{ display: "none" }} />

      <div style={{ position: "relative", zIndex: 1 }}>
        <StewardedShell>
          <ModeHeader title="Echoes of Fate" onShare={demo.shareCanon} showTitle={false} showRoles={false} showShare={false} />
            ...
            {demo.showFullHero && (
              <HeroOnboarding
                ...
                onSetDmMode={(nextMode) => {
                  ...
                  demo.setPartyDraft((prev) => prev ?? null);
                }}
          ...
          {demo.showGameplay && demo.allowGameplay && (
            <>
                    ...
                    <div style={{ display: "grid", gap: 14 }}>
                      ...
                      >
                        ...
                        <div style={{ fontSize: 12, opacity: 0.8, lineHeight: 1.6 }}>
                          Room pressure {demo.dungeonEvolution.debug.roomPressure} · Room awareness {demo.dungeonEvolution.debug.roomAwareness} · Nearby pressure {demo.dungeonEvolution.debug.nearbyPressureMax}
                        </div>
                      </div>
                      ...
                      {demo.dungeonEvolution.signals.length > 0 && (
                        ...
                        >
                          ...
                          <ul style={{ margin: 0, paddingLeft: 18 }}>
                            {demo.dungeonEvolution.signals.map((signal, idx) => (
                    ...
                    <div style={{ display: "grid", gap: 16 }}>
                      ...
                      <div style={{ display: "grid", gap: 10 }}>
                        ...
                        {demo.roomFeatureNarrative.length === 0 ? (
                          ...
                          >
                            <ul style={{ margin: 0, paddingLeft: 18 }}>
                              {demo.roomFeatureNarrative.map((line, idx) => (
                        ...
                        {demo.roomConnectionsView.length === 0 ? (
                          ...
                          <>
                            {demo.roomExitNarrative.length > 0 && (
                              ...
                              >
                                <ul style={{ margin: 0, paddingLeft: 18 }}>
                                  {demo.roomExitNarrative.map((line, idx) => (
                                    <li key={`${idx}-${line}`} style={{ marginBottom: 6, lineHeight: 1.55 }}>
                                      {line}
                                    </li>
                                  ))}
                            ...
                            {demo.roomConnectionsView.map((route) => (
                              <div
                                key={route.id}
                                style={{
                                  padding: 12,
                      ...
                      <div style={{ display: "grid", gap: 10 }}>
                        ...
                        {demo.currentFeatures.length === 0 ? (
                          ...
                          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                            {demo.currentFeatures.map((feature, idx) => (
                              <span
              ...
              <details open={demo.combatActive} style={{ marginTop: 16 }}>
                ...
                <div id={anchorId("combat")} style={{ scrollMarginTop: 90 }}>
                  <CombatSection
                    ...
                    partyMembers={demo.partyMembers.map((m, idx) => ({
                      id: String(m.id),
                    ...
                    onCommitOutcomeOnly={(payload) => demo.handleRecordOutcomeOnly(payload)}
