...
function PressureGaugeVisual(props: { puzzleResult: any | null }) {
  const { puzzleResult } = props;
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {props.puzzleResult ? "Corridor — Trial Engaged" : "Corridor — Passage Blocked"}
            </div>
          </div>
    ...
    <div id={anchorId("puzzle")} style={{ scrollMarginTop: 90 }}>
      ...
      >
        <div style={{ display: "grid", gap: 14 }}>
          <PressureGaugeVisual puzzleResult={puzzleResult} />
