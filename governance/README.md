...
Canonical-Block-Hash: SHA256_TO_BE_FILLED  
Canonical-Locked: 2026-01-14

---

This repository enforces RIGOR as a **regime**, not a guideline.

- Refusal is structural.
- Silence is valid.
- Overrides are forbidden except by explicit, auditable regime change.
- Narrative, motivation, or intent do not modify enforcement.

No supplementary interpretation is permitted in this file.
